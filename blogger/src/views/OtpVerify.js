...
function OtpVerify() {
  ...
  return (
    <div className="container-otp-verify">
      <video autoPlay muted loop id="background-video-otp-verify">
      ...
      <div className="form-container-otp">
        <div className="otp-verify">
          ...
          <label className='label-otp' htmlFor="otp">
            Enter OTP:
          </label>
          <input
            type="text"
          ...
          <button className='otp-button' onClick={handleVerifyButtonClick}>
            Verify
          </button>
          <p className="expiration-time">
            {remainingTime.minutes} minutes {remainingTime.seconds} seconds remaining
            {showSendAgain && (
              <button className='otp-button-again' onClick={handleSendAgainClick}>
                Send Again
              </button>
            )}
          </p>
